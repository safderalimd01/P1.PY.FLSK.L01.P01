-- stored procedure to list active or inactive products
...
set oparam_err_flag = 0;
 ...
 -- step 30
-- list products by applying product status filter
...
-- GRANT EXECUTE ON PROCEDURE sproc_product_list_by_active_status to '<my sql user id>';	
